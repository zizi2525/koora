...
export default function Home({ matches }) {
  return (
    ...
    <main className="grid grid-cols-6 pb-16 pt-4 dark:bg-zinc-950 ">
      ...
      <h1 className="text-2xl font-bold text-gray-700 dark:text-gray-300 p-2 m-2">مباريات الغد</h1>
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <Link href="/tomorrow-matches" className="text-md font-bold text-gray-700 dark:text-gray-300 bg-red-500 px-4 py-2 animate-pulse">
